...
def parse_args():
    ...
    parser.add_argument('--epochs', type=int, default=500, help='number of epochs, depends on your lr schedule 500 or 1000+ is available!')
    ...
    parser.add_argument('--backbone-mode', type=str, default='detlnet_1k', help='backbone mode: detlnet_sir, detlnet_1k')
